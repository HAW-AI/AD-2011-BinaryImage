...
public class View extends Applet {
	...
	private Button buttonDrawBoundary = new Button("R�nder");
	private Button buttonInverse = new Button("invertieren");
	private Button buttonChooseFile = new Button("Datei laden...");

	// panel h�lt die Buttons
	private final Panel panel = new Panel();
	// panel2 h�lt die TextArea zur circularity ausgabe
	private final Panel panel2 = new Panel();
	// distance h�lt die h�he von panel + panel2
	private final int distance;
	// textAreaCircularity zur ausgabe der Circularit�ten
