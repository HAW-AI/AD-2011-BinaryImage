...
public class BlobTest {
    ...
    public void testCircularity() {
        // Quadrat links oben (AREA = 48, PERI = 24 * 1 + 0 * sqrt(2)
        assertEquals(4 * Math.PI * 48 / Math.pow(24, 2), Bi.blob(0).circularity(), 0.001);
        // Fastkreis rechts (AREA = 80, PERI = 20 * 1 + 8 * sqrt(2)
        assertEquals(4 * Math.PI * 80 / Math.pow(31.31, 2), Bi.blob(7).circularity(), 0.001);
    }
}
